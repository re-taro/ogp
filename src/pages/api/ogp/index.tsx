...
const iconPath = join(process.cwd(), "..", "_static/rintaro.webp");
const icon: string = readFileSync(iconPath, "base64");
const monopath = join(process.cwd(), "..", "_static/fonts/RobotoMono-Medium.woff2");
const mono = readFileSync(monopath).toString("base64");
const notopath = join(process.cwd(), "..", "_static/fonts/NotoSansJp-Bold.woff2");
