...
const iconPath = path.join(basePath, "public/rintaro.webp");
// eslint-disable-next-line security/detect-non-literal-fs-filename
const icon: string = fs.readFileSync(iconPath, "base64");
const monopath = path.join(basePath, "public/fonts/RobotoMono-Medium.woff2");
// eslint-disable-next-line security/detect-non-literal-fs-filename
const mono = fs.readFileSync(monopath).toString("base64");
const notopath = path.join(basePath, "public/fonts/NotoSansJp-Bold.woff2");
// eslint-disable-next-line security/detect-non-literal-fs-filename
